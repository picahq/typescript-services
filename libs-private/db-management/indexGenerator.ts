...
const collectionsWithIndexes: Record<string, IndexSpecification[]> = {
  ...
  'external-events': [
    ...
    { field: { createdAt: 1 }, name: 'createdAt_1' },
    { field: { state: 1 }, name: 'state_and_createdAt_1' },
    { field: { createdAt: 1 }, name: 'state_and_createdAt_1' },
    { field: { deleted: 1 }, name: 'logs_1' },
    { field: { environment: 1 }, name: 'logs_1' },
    { field: { createdAt: 1 }, name: 'logs_1' },
    { field: { "ownership.buildableId": 1 }, name: 'logs_1' },
  ],
  jobs: [
